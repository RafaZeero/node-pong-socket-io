...
function ballReset() {
  ...
  // Reset ball movement for both players
...
function ballMove() {
  ...
  // emit ball movement to both players
  socket.emit('ballMove',{
    ballX,
    ballY,
    score
...
// Called Every Frame
function animate() {
  // update ball movement based on only one player
  if(isReferee){
    ballMove();
    ballBoundaries();
  }
...
function startGame(){
  ...
  canvas.addEventListener('mousemove', e => {
    ...
    // emit paddle movement so others players
